...
app.controller('ProductCtrl', function($scope, $controller, $http, $location, $routeParams) {
  ...
  $scope.delete = function(obj) {
    ...
    var req = { method: 'DELETE', url: '/api/products/'+obj.codigo}

        $http(req).success(function(data, status, headers, config) {

            $location.path('/produtos');

            $.notify({message: 'Registro excluido com sucesso.'},
                     {type: 'success'});

        }).
        error(function(data, status, headers, config) {

          $.notify({message: 'Erro ao excluir registro'},
                   {type: 'danger'});
  ...
  $scope.save = function(obj) {
    ...
    if(obj.id > 0){
      ...
      var req = { method: 'PUT', url: '/api/products/'+obj.codigo, data:obj}
...
app.controller('ClienteCtrl', function($scope, $controller, $http, $location, $routeParams) {
  ...
  $scope.delete = function(obj) {
    ...
    var req = { method: 'DELETE', url: '/api/clientes/'+obj.codigo}
  ...
  $scope.save = function(obj) {
    ...
    if(obj.id > 0){
      ...
      var req = { method: 'PUT', url: '/api/clientes/'+obj.codigo, data:obj}
...
app.controller('PedidoCtrl', function($scope, $controller, $http, $location, $routeParams) {
  ...
  $scope.save = function(obj) {
    ...
    if(obj.id > 0){
      ...
      var req = { method: 'PUT', url: '/api/pedidos/'+obj.numero, data:obj}
  ...
  $scope.delete = function(obj) {
    ...
    var req = { method: 'DELETE', url: '/api/pedidos/'+obj.numero}
